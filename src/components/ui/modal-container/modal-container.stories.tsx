...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Container base para modais com estrutura padronizada: header (titulo/subtitulo/fechar), corpo flexÃ­vel e footer com aÃ§Ãµes.",
      },
    },
  },
  args: {
    ...
    children: (
      <div style={{ padding: "24px", display: "grid", gap: "8px" }}>
        <strong>ConteÃºdo dinÃ¢mico</strong>
        <span>Esse espaÃ§o representa o conteÃºdo variÃ¡vel de cada modal.</span>
      </div>
    ),
    footer: (
      <>
